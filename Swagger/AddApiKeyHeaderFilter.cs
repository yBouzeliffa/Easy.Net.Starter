...
namespace Easy.Net.Starter.Swagger
{
    public class AddApiKeyHeaderFilter : IOperationFilter
    {
        ...
        public AddApiKeyHeaderFilter(string defaultHeaderName, string defaultValue)
        {
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            operation.Parameters.Add(new OpenApiParameter
            {
                ...
                Required = true,
                Schema = new OpenApiSchema { Default = new OpenApiString(_defaultValue, true), Type = "string" } // Utilisez la valeur par défaut
            });
        }
    }
}
